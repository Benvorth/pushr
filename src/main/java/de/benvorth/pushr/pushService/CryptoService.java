...
// source: https://github.com/ralscha/blog2019/blob/master/webpush/src/main/java/ch/rasc/webpush/CryptoService.java
@Component
public class CryptoService {
    ...
    public CryptoService() {
        try {
            ...
            PushrApplication.logger.error("init crypto", e);
        }
    }
